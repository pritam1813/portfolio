...
const contactInfo = [
    {
        icon: 'email',
        label: 'Email',
        value: 'pritam1813@gmail.com',
        href: 'mailto:pritam1813@gmail.com',
    },
    {
        icon: 'location',
        label: 'Location',
...
const socialLinks = [
    ...
    { label: 'LinkedIn', href: 'https://linkedin.com/in/pritam1813', icon: 'linkedin' },
...
export function Contact() {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            const response = await fetch('https://formspree.io/f/xqeqvdyb', {
                method: 'POST',
                headers: {
